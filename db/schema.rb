...
ActiveRecord::Schema.define(version: 20140628144441) do
  ...
  add_index "users", ["encrypted_auth_token"], name: "index_users_on_encrypted_auth_token", unique: true, using: :btree
